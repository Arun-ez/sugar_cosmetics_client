        ...
        <Flex className='navbar' w="100vw" direction="column">
            ...
            >
                ...
                <Flex w="40%" border="1px solid white" borderRadius="8px" overflow="hidden" display={["none", "none", "none", "flex"]}>
                    ...
                    <Button borderRadius="0px" w="20%"> Search </Button>
                </Flex>
            ...
            <Flex display={["none", "none", "none", "flex"]} bg="#141414" color="white" h="55px" alignItems="center" gap="3%" paddingLeft="40px" fontSize="14px" whiteSpace="nowrap">
                {nav_routes.map(({ name, path }, id) => {
                    return <NavLink to={path} key={id}> {name} </NavLink>
                })}
            </Flex>
